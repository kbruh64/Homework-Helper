...
<main class="wrap">
  ...
  <section id="screen-flash" style="display:none;">
    <div class="flash-wrap">
      ...
      <div class="flash-deck" id="flash-deck">
        <!-- peeking cards behind the active one -->
        <div class="flash-ghost flash-ghost-2" aria-hidden="true"></div>
        <div class="flash-ghost flash-ghost-1" aria-hidden="true"></div>
      ...
      <div class="flash-actions" id="flash-rate" style="display:none;">
        <button class="csa-chip flash-again" data-rate="again" type="button">&larr; Review again</button>
        <button class="csa-chip flash-good" data-rate="good" type="button">Got it &rarr;</button>
      </div>
    </div>
  </section>
  ...
  <section id="screen-speed" style="display:none;">
    <div class="speed-wrap">
      <div class="speed-start" id="speed-start">
        ...
        <p class="lede">60 seconds on the clock. Answer as many as you can before time runs out. Your best score goes on the leaderboard.</p>
        <button class="speed-go" id="speed-go" type="button">Start the clock &rarr;</button>

        <div class="leaderboard" id="lb-start">
          <div class="lb-head">
            <span class="lb-title">${t.title} &mdash; Top scores</span>
            <span class="lb-live" id="lb-live-start">live</span>
          </div>
          <ol class="lb-list" id="lb-list-start"><li class="lb-empty">Loading…</li></ol>
        </div>
      </div>
  ...
  <section id="screen-result" style="display:none;">
    <div class="result-card">
      ...
      <div class="leaderboard" id="lb-result" style="display:none;">
        <div class="lb-head">
          <span class="lb-title">${t.title} &mdash; Top scores</span>
          <span class="lb-live" id="lb-live-result">live</span>
        </div>
        <ol class="lb-list" id="lb-list-result"><li class="lb-empty">Loading…</li></ol>
      </div>
